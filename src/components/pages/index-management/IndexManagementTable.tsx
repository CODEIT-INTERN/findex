...
const IndexTable = () => {
  ...
  return (
    <div className="scrollbar-thin flex-1 overflow-auto">
      ...
      >
        <Table.Header>
          <Table.Head
            ...
            isRowHeader
            allowsSorting
            isActive={isActiveSortColumn("indexClassification", sortDescriptor)}
          />
          <Table.Head
            id="indexName"
            label="지수"
          ...
          <Table.Head
            ...
            label="채용 종목 수"
            allowsSorting
            isActive={isActiveSortColumn("employedItemsCount", sortDescriptor)}
          />
          <Table.Head
            id="basePointInTime"
            label="기준 시점"
      ...
      {/* TODO: empty 컴포넌트로 변경 */}
      {hasNoData && (
        <div className="flex h-full min-h-[50vh] flex-1 flex-col items-center justify-center gap-3 text-center">
          <div className="flex flex-col items-center justify-center">
            {" "}
            <span className="text-quaternary text-sm font-semibold">
              등록된 지수 정보가 없습니다.
            </span>
            <Button
